...
const date12 = new Date("2024-01-05"); // Year-Month-Day
const date23 = new Date("January 5, 2024"); // Month Day, Year
console.log(date12);
console.log(date23);
...
const addDaysToDate = (dates, extraDay) => {
    console.log(dates.getDate());
    console.log(dates.setDate(dates.getDate() + extraDay));
